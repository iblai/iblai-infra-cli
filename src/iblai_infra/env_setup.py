...
def build_setup_config_from_env(
    ...
    *,
    ...
    return SetupConfig(
        ...
        ecr_aws_access_key_id=(env.get("ECR_AWS_ACCESS_KEY_ID") or "").strip(),
        ecr_aws_secret_access_key=(env.get("ECR_AWS_SECRET_ACCESS_KEY") or ""),
        ecr_aws_default_region=(env.get("ECR_AWS_DEFAULT_REGION") or "").strip(),
